...
df_elec = df.loc[df['Type de Produit'] == 'Électronique']

# Échantillonnage aléatoire pour conserver 10% des données
df_sampled = df_elec.sample(frac=0.1)
...
plt.title('Régression Linéaire Simple - Ventes des produits Électroniques en fonction du Budget Radio')
plt.legend()
plt.show()